                ...
                <div class="px-8">
                    ...
                    <ul class="mt-12">
                        <li class="flex w-full justify-between text-black cursor-pointer items-center mb-6">
                            <a href="{{url('/statistic')}}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-fuchsia-400">
                        ...
                        <li class="flex w-full justify-between text-black hover:text-fuchsia-500 cursor-pointer items-center mb-6">
                            <a href="{{url('/add-product')}}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                        ...
                        <li class="flex w-full justify-between text-black hover:text-fuchsia-500 cursor-pointer items-center mb-6">
                            <a href="{{url('/add-category')}}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                        ...
                        <li class="flex w-full justify-between text-black hover:text-fuchsia-500 cursor-pointer items-center mb-6">
                            <a href="{{route('product.create')}}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <span class="text-sm ml-2">pro1</span>
                            </a>
                        </li>
                        <li class="flex w-full justify-between text-black hover:text-fuchsia-500 cursor-pointer items-center">
                            {{-- this url does't work --}}
                            <a href="{{url('/profile.edit')}}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white"> 
                    ...
                    <div class="flex justify-center mt-48 mb-4 w-full">
                        <div class="relative">
                            ...
                            <input class="bg-fuchsia-900 focus:outline-none focus:ring-1 focus:ring-gray-100 rounded w-full text-sm text-white placeholder-white pl-10 py-2" type="text" placeholder="Search" />
                        </div>
                    </div>
                </div>
                ...
                <div class="px-8">
                    ...
                    <ul class="mt-12">
                        ...
                        <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                ...
                                <span class="text-sm ml-2"> <a href="{{url('/add-product')}}">testProducts</span> </a>
